...
Route::prefix('customer')->group(function () {
    ...
    Route::middleware('auth')->prefix('dashboard-customer')->group(function () {
        ...
        Route::get('tiket/{id}', 'App\Http\Controllers\Customer\TiketCustomerController@detail')->name('tiket.detail');
        Route::get('tiket/{id}/cetak-pdf', 'App\Http\Controllers\Customer\TiketCustomerController@cetak_pdf')->name('tiket.cetak');
    });
});
