                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-container">
                            <h1> <span id="js-rotating">PELABUHAN TENGKAYU, KOTA TARAKAN</span></h1>
                            <p class="p-heading p-large">Website Pemesanan Speed Pelabuhan Tengkayu 1 Kota Tarakan</p>
                            <a class="btn-solid-lg page-scroll" href="{{route('customer.login.get')}}">PESAN</a>
                        </div>
                    </div> <!-- end of col -->
                </div> <!-- end of row -->
